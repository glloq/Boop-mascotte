...
2. **Add hands (optional).** **Face Setup → Hands → Draw a pair of hands** gives the mascot two four-fingered hands, rigged, with Fist, Point and Peace poses and a Wave to try — no SVG to import. They are also in **Artwork → Add / Create artwork**.
