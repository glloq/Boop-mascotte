...
8. **Add Blink.** Open **Behaviors → Reactions** and scroll to **Automatic**, under the reactions. The template already blinks, glances around and breathes with a slow head movement; turn any of them off, or on for imported artwork. **Test** shows each one. They are ordinary Behaviors: **Behaviors (advanced)**, under **States & behaviors** at the bottom of the Motions column, adds any of the four kinds the runtime has — Blink, Random Idle, Oscillator and Drift — and keeps every value editable.
