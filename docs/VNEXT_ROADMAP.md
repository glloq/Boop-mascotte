...
| VNX-22 | ⤫ **Superseded.** The pose editor was built on a hand made of six deforming parts with a pseudo-3D facing axis; that hand is gone. A hand is now one of six **static drawings** chosen by name, and there is nothing inside one to edit (`docs/HAND_STYLES.md`) |
