...
- A [Character Builder](docs/CHARACTER_BUILDER.md): the parts a person names, picked, moved, resized and recoloured on the same canvas, with Edit Shape and Advanced leading to the full tools
