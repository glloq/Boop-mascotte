...
const allowed=new Set(['core/state/editor-store.js','core/undo/history.js','main.js','core/tests/release-regressions.test.js','core/tests/preview-timeline.test.js']);
