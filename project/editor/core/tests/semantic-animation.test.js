...
test('semantic registry covers the part vocabulary, with the V2 hands', () => {
  assert.deepEqual(Object.keys(SEMANTIC_PART_REGISTRY), ['head', 'eyes', 'gaze', 'eyelids', 'eyebrows', 'nose', 'mouth', 'tongue', 'jaw', 'hair', 'ears', 'leftHand', 'rightHand', 'accessory', 'facialHair']);
});
