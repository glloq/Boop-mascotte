...
const required={basic:['head','eyeLeft','eyeRight','pupilLeft','pupilRight','mouth'],expressive:['head','eyeLeft','eyeRight','pupilLeft','pupilRight','browLeft','browRight','upperLidLeft','upperLidRight','nose','mouth','jaw','moustache','hair'],talking:['head','eyeLeft','eyeRight','pupilLeft','pupilRight','mouthBase','mouth','jaw']};
