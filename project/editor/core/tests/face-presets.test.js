...
import { CUSTOM_PRESETS_KEY, FACE_PALETTES, FACE_PRESET_LIBRARY, FACE_STYLE_PRESETS, FacePresetError, PRESET_PART_ORDER, createFacePresetRegistry, facePresetFromDocument, loadCustomPresets, normalizeFacePreset, planFacePreset, presetColours, presetOfFace, presetThumbnail, saveCustomPresets, validateFacePreset } from '../face-library/face-presets.js';
...
test('a preset is normalised and validated: real categories, real assets in them, a known palette, one id', () => {
  ...
  assert.deepEqual(item, { id: 'Mine', name: 'Mine', description: '', parts: { head: 'head.round' }, accessories: ['accessory.hat'], palette: { skin: '#abc' }, origin: 'custom' });
