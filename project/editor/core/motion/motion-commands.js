import { createMotionClip, detachMotion, duplicateMotionClip, removeMotionClip, renameClip, resetMotion, setClipBlend, setClipLoop, setMotionBlend, updateMotionSettings } from './motion-model.js';
...
export function createMotionCommands(store, history) {
  ...
  return {
    ...
    setClipBlend(id, mode) { return run('motion/set-clip-blend', (d) => setClipBlend(d, id, mode).blend || 'override'); },
