...
const mouth = (slug, name, description, shapes, { roles, capabilities, box, palette }) => Object.freeze({
...
export const MOUTH_SMALL = mouth('small', 'Small', 'A small curved line.',
  ...
  { roles: { mouth: 'mouth' }, capabilities: ['mouthOpen', 'smile', 'mouthWidth'], box: { x: 108, y: 173, width: 24, height: 9 }, palette: ['mouth'] });
export const MOUTH_CARTOON = mouth('cartoon', 'Cartoon', 'An open cartoon grin with teeth and a tongue.',
  ...
  { roles: { mouth: 'mouth', teeth: 'teeth', tongue: 'tongue' }, capabilities: ['mouthOpen', 'smile', 'mouthWidth', 'teeth', 'tongue'], box: { x: 90, y: 166, width: 60, height: 32 }, palette: ['mouth', 'teeth', 'tongue'] });
export const MOUTH_EXPRESSIVE = mouth('expressive', 'Expressive', 'Full lips, drawn as one shape.',
  ...
  { roles: { mouth: 'mouth' }, capabilities: ['mouthOpen', 'smile', 'mouthWidth'], box: { x: 88, y: 168, width: 64, height: 21 }, palette: ['mouth'] });
