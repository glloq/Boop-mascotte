...
const nose = (slug, name, description, shape, box) => Object.freeze({
...
export const NOSE_CARTOON = nose('cartoon', 'Cartoon', 'A big round cartoon nose.', `<ellipse id="nose" data-name="Nose" cx="120" cy="150" rx="11" ry="9" fill="${SKIN}" stroke="${LINE}" stroke-width="2.4" />`, { x: 109, y: 141, width: 22, height: 18 });
