...
export function applyTemplateProject(state, kind) {
  ...
  else if(kind==='basic') {add(state,'eyes',{leftEye:'eyeLeft',rightEye:'eyeRight'},['eyeOpen']);state.behaviors=[];state.animationClips=[clips.look,clips.blink,clips.smile];state.faceFeatures=['core'];}
