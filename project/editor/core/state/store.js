...
export function createCleanProjectState() {
  ...
  behaviors: [], transitionSettings: {}, semanticParts: {}, animationClips: [], expressions: [], reactions: [], keyforms: [], shapeKeys: [], warps: [], meshes: [], rigPins: [], rigConstraints: [], rigAttachments: [], rigHolds: [], hands: null, rigHandles: [], rigLinks: [], gazeSolver: null, arrangement: { placements: [] }, deformers: [], parallax: null, expressionBlend: null, motionBlend: null,
