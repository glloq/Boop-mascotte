...
const HAND_SHAPE = Object.freeze({ Grip: 'Close the hand', Flip: 'Palm or back', Facing: 'Palm or side', Show: 'Out from behind the head', Drawing: 'Which drawing', Anim: 'Play this drawing\u2019s animation' });
