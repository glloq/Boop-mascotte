...
export const LEGACY_TASK_ALIASES = Object.freeze({ create: 'artwork', rig: 'face-setup', expressions: 'expressions', animate: 'animate', preview: 'preview' });
const TARGET_KINDS = new Set(['artwork-element', 'semantic-part', 'semantic-control', 'expression', 'animation-clip', 'timeline-track', 'timeline-key', 'state', 'diagnostic']);
