 ...
 * hair, accessories -- is in `#face-library`, above these on Design ▸ Assemble,
 * which is where an author picks a different pair of eyes rather than being
 * offered "+ Add" for a part they already have (docs/FACE_PART_LIBRARY.md).
 *
