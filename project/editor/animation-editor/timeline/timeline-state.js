export function createTimelineState(){return {selectedKeys:[],selectedTrack:null,zoom:1,scrollLeft:0,collapsedGroups:new Set(),clipboard:null,marquee:null,drag:null,snap:true,fps:30,panelHeight:210};}
