...
export const SEMANTIC_PART_REGISTRY = Object.freeze({
  ...
  eyes: { displayName: 'Eyes', roles: ['leftEye', 'rightEye'], controls: ['eyeOpen'], parameters: { eyeOpen: number(0, 1, 1) }, bindings: { leftEye:{eyeOpen:'scaleY'},rightEye:{eyeOpen:'scaleY'} }, strategies:{eyeOpen:['scaleY','morph','eyelid']}, symmetry: true },
  ...
  mouth: { displayName: 'Mouth', roles: ['mouth'], controls: ['mouthOpen', 'smile', 'mouthWidth'], parameters: { mouthOpen: number(0, 1), smile: number(-1, 1), mouthWidth: number(-1, 1) }, bindings:{mouth:{mouthOpen:'scaleY',smile:'translateY',mouthWidth:'scaleX'}}, strategies:{mouthOpen:['scaleY','morph'],smile:['translateY','morph'],mouthWidth:['scaleX','morph']}, morph: true },
