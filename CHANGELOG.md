...
- Readiness-driven Export with deep links, command palette (Ctrl/Cmd+K), tablet drawer and bottom sheet, mobile priority mode, and an accessibility and keyboard gate (landmarks, skip link, shortcut help, Escape order, reduced motion).
